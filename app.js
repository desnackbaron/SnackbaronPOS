...
const PRODUCTS=[{"id":"hamburger","name":"Hamburger","price":5.5,"cost":1.511,"vat":0.06,"cat":"Burgers","targetStock":40},{"id":"angus-beefburger","name":"Angus Beefburger","price":8.5,"cost":2.49,"vat":0.06,"cat":"Burgers","targetStock":10},{"id":"kip-burger-xl","name":"Kip burger XL","price":8.0,"cost":2.11,"vat":0.06,"cat":"Burgers","targetStock":10},{"id":"cheeseburger","name":"Cheeseburger","price":6.0,"cost":1.471,"vat":0.06,"cat":"Burgers","targetStock":30},{"id":"cheeseburger-royale","name":"Cheeseburger Royale","price":8.0,"cost":2.202,"vat":0.06,"cat":"Burgers","targetStock":20},{"id":"spekburger","name":"Spekburger","price":6.5,"cost":1.835,"vat":0.06,"cat":"Burgers","targetStock":25},{"id":"bicky-burger","name":"Bicky","price":5.5,"cost":1.331,"vat":0.06,"cat":"Burgers","targetStock":15},{"id":"bicky-cheese","name":"Bicky Cheese","price":6.0,"cost":1.531,"vat":0.06,"cat":"Burgers","targetStock":10},{"id":"broodje-mexicano","name":"Mexicano","price":7.5,"cost":2.16,"vat":0.06,"cat":"Broodjes","targetStock":20},{"id":"broodje-mexicano-cheese","name":"Mexicano Cheese","price":8.0,"cost":2.36,"vat":0.06,"cat":"Broodjes","targetStock":15},{"id":"broodje-braadworst","name":"Broodje Braadworst","price":8.0,"cost":2.38,"vat":0.06,"cat":"Broodjes","targetStock":20},{"id":"braadworst","name":"Losse Braadworst","price":4.5,"cost":1.34,"vat":0.06,"cat":"Snacks","targetStock":20},{"id":"pulled-pork","name":"Pulled Pork","price":10.0,"cost":3.14,"vat":0.06,"cat":"Specials","targetStock":20},{"id":"smokey-chicken","name":"Smokey Chicken","price":10.0,"cost":3.12,"vat":0.06,"cat":"Specials","targetStock":20},{"id":"chicken-tandoori","name":"Chicken Tandoori","price":10.0,"cost":3.37,"vat":0.06,"cat":"Specials","targetStock":20},{"id":"broodje-curryworst","name":"Curryworst","price":5.5,"cost":1.42,"vat":0.06,"cat":"Broodjes","targetStock":20},{"id":"curryworst","name":"Losse Curryworst","price":2.5,"cost":0.47,"vat":0.06,"cat":"Snacks","targetStock":20},{"id":"extra-kaas","name":"Extra kaas","price":0.5,"cost":0.169,"vat":0.06,"cat":"Extra's","targetStock":20},{"id":"extra-spek","name":"Extra spek","price":1.0,"cost":0.564,"vat":0.06,"cat":"Extra's","targetStock":0},{"id":"plat-water","name":"Water","price":2.2,"cost":0.48,"vat":0.06,"cat":"Dranken","targetStock":24,"image":"images/plat-water.png"},{"id":"bruis-water","name":"Bruis","price":2.5,"cost":0.58,"vat":0.06,"cat":"Dranken","targetStock":24,"image":"images/bruis-water.png"},{"id":"cola","name":"Cola","price":2.5,"cost":0.73,"vat":0.06,"cat":"Dranken","targetStock":24,"image":"images/cola.png"},{"id":"cola-zero","name":"Cola Zero","price":2.5,"cost":0.9,"vat":0.06,"cat":"Dranken","targetStock":24,"image":"images/cola-zero.png"},{"id":"fanta","name":"Fanta","price":2.5,"cost":0.9,"vat":0.06,"cat":"Dranken","targetStock":24,"image":"images/fanta.png"},{"id":"sprite","name":"Sprite","price":2.5,"cost":0.73,"vat":0.06,"cat":"Dranken","targetStock":24,"image":"images/sprite.png"},{"id":"jupiler","name":"Jupiler","price":2.5,"cost":1.02,"vat":0.21,"cat":"Dranken","targetStock":24,"image":"images/jupiler.png"},{"id":"jupiler-00","name":"Jupiler 0,0","price":2.5,"cost":0.88,"vat":0.06,"cat":"Dranken","targetStock":24,"image":"images/jupiler-00.png"},{"id":"red-bull","name":"Red Bull","price":3.2,"cost":1.3,"vat":0.06,"cat":"Dranken","targetStock":12,"image":"images/red-bull.png"},{"id":"ice-tea","name":"Ice Tea","price":2.5,"cost":0.642,"vat":0.06,"cat":"Dranken","targetStock":24,"image":"images/ice-tea.png"},{"id":"ice-tea-peach","name":"Peach","price":2.5,"cost":0.82,"vat":0.06,"cat":"Dranken","targetStock":24,"image":"images/ice-tea-peach.png"},{"id":"dr-pepper","name":"Dr Pepper","price":2.5,"cost":0.82,"vat":0.06,"cat":"Dranken","targetStock":20,"image":"images/dr-pepper.png"}];
const COSTS=Object.fromEntries(PRODUCTS.map(p=>[p.id,p.cost]));
const PRO_WEBAPP_URL="https://script.google.com/macros/s/AKfycbzHl9ipWCPizzREckrD68iiiJDrZceudG0h7SyDnW_we1gniC7WU5u-WiVjZChDHZ6U/exec";
const PRO_TOKEN="SNACKBARON-POS-2026";
...
function exportSnackbaronPRO(){
  ...
  const header=[
    ...
    "Losse Curry Worst","Extra Kaas ","Extra Spek","Water","Bruis","Cola","Cola Zero","Fanta","Sprite",
  ...
  const row=[
    ...
    counts["hamburger"]||0,counts["angus-beefburger"]||0,counts["kip-burger-xl"]||0,counts["cheeseburger"]||0,counts["cheeseburger-royale"]||0,
    ...
    counts["broodje-curryworst"]||0,counts["curryworst"]||0,counts["extra-kaas"]||0,counts["extra-spek"]||0,
    ...
    cash+payconiq,(cash+payconiq)-total,"","","",gross,"Export Snackbaron POS v3.6 – prijzen Snackbaron PRO v5.0","","",""
  ];
...
document.getElementById("closeDayBtn").onclick=openCloseDay;
document.getElementById("closeDayDialogBtn").onclick=()=>document.getElementById("closeDayDialog").close();
document.getElementById("sendToProBtn").onclick=sendToPRO;
